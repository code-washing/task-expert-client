...
const Banner = () => {
   ...
   return (
      <div className='grid grid-cols-1 gap-12 sm:gap-[5rem] lg:gap-0 lg:grid-cols-2 items-center'>
         ...
         {/* banner image part */}
         <div className='w-full h-full sm:w-[80%] lg:w-full mx-auto'>
            <Image
               width={600}
               height={450}
               priority={true}
               src={bannerImg}
               className='!w-full !h-full !object-cover rounded-l-full rounded-tr-full lg:rounded-tr-none shadow-medium'
