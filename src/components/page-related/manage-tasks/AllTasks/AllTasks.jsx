...
const AllTasks = ({ modifyClasses = '' }) => {
   ...
   return (
      <div
         className={`h-[57vh] md:h-[70vh] lg:h-[60vh] 2xl:h-[65vh] bg-white mx-auto w-[52.5rem] xs:w-[60rem] sm:w-[70rem] xl:max-w-[89.5rem] xl:w-full shadow-medium rounded-xl ${modifyClasses}`}
      >
         {isLoading && (
            <LoadingSpinner
               text='Loading Data'
