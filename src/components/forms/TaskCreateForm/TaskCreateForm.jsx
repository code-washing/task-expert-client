...
const TaskCreateForm = () => {
   ...
   return (
      <div
         ...
         } translate-x-4 md:translate-x-8 shadow-md w-[16rem] xs:w-[19rem] absolute top-0 translate-y-[3.2rem] left-0 p-4 bg-white border border-neutral-300 z-40 rounded-xl task-create-form-focus`}
      >
         <CloseBtn
